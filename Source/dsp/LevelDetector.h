 ...
 * In this compressor implementation it's used in log. domain after the gain
 * computer to smooth the calculated attenuations, therefore the detector does
 * not have to work on the whole dynamic range of the input signal
 */
class LevelDetector
{
  public:
    ...
    // Prepares LevelDetector with a ProcessSpec-Object containing samplerate,
